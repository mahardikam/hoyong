        ...
        <div class="col-md-8 text-center">
            <div class="card mb-4">
                <div class="image-section text-center p-3">
                    @if ($product->photo)
                        <img src="{{ url('image/' . $product->photo) }}" alt="{{ $product->name }}" class="img-fluid" style="max-width: 300px;">
                    @else
            ...
            <div class="card p-3">
                ...
                <p class="card-price text-danger font-weight-bold">Rp{{ number_format($product->price, 0, ',', '.') }}
                </p>
            ...
            <input type="number" class="form-control mb-3 text-center mx-auto" name="quantity" id="quantity" value="1"
    ...
    <div class="col-md-8 text-center mt-4">
        <div class="d-flex justify-content-around">
            ...
            <form action="{{ route('checkout.frontend') }}" method="GET" class="d-inline-block mx-1">
                ...
                <input type="hidden" name="quantity" id="hidden_quantity" value="1"> <br>
